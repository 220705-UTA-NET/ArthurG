...
namespace Project_00
{
    class DATA_Menu
    {
        ...
        private static readonly string DB_COMMAND_printLeaderboardByTurns = @"SELECT TOP 10 * FROM Project00_Wordle.Leaderboards ORDER BY Used_Turns ASC;";
        private static readonly string DB_COMMAND_printLeaderboardByTime = @"SELECT TOP 10 * FROM Project00_Wordle.Leaderboards ORDER BY Used_Time ASC;";
        // Constructor
        public DATA_Menu()
        {
